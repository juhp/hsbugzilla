...
searchRequest :: BugzillaSession -> SearchExpression -> Request
searchRequest session search =
  let searchQuery = evalSearchExpr search in
    newBzRequest session ["bug"] searchQuery
